...
//   }
//
//   double pad, halfWidth, width, height, w, h, titleFont, textFont = 0;
//   double canvas = 128;
//
...
//                             setState(() {});
//                           },
//                           child: Text("next", style: TextStyle(fontSize: textFont),),
//                           color: Colors.blue,
...
//           Text(
//             "Gender",
//             style: TextStyle(fontSize: titleFont, color: Colors.black, fontWeight: FontWeight.bold),
//           ),
//           Padding(
...
//                   },
//                 ),
//                 Text('Male', style: TextStyle(fontSize: textFont)),
//                 Radio(
//                   value: 'Female',
//                   groupValue: gender,
...
//       children: <Widget>[
//         Text("Canvas", style: TextStyle(fontSize: titleFont, fontWeight: FontWeight.bold)),
//         Row(
